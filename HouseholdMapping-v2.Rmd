...
# Key Data Statistics
df_table <- data.frame(`Data Items` = c("Total records (buildings) on REDCap", "Duplicate/blank records (buildings)", "Total valid buildings", "Total buildings with EA Code", "Total Residential", "Total Non-residential", "Geolocation", "Total No. of households", "About the household", "Pregnant women", "Maternal death", "Stillbirth"),
